...
$expected = @(
    ...
    [ordered]@{ key = 'emergency_stop'; automation_id = '209'; name = 'Аварійний STOP виконання / Emergency execution STOP (Ctrl+Shift+S)'; required_pattern = 'Invoke'; require_external_focus = $true; expected_control_type = 'ControlType.Button'; require_named_rows = $false },
