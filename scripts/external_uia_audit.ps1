...
$expected = @(
    ...
    [ordered]@{ key = 'operational_status'; automation_id = '206'; name = 'Операційний стан Автоспорт'; required_pattern = 'Value'; require_external_focus = $true; expected_control_type = 'ControlType.Edit'; require_named_rows = $false; require_value_read_only = $true },
