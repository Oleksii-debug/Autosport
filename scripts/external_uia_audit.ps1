...
$expected = @(
    ...
    [ordered]@{ key = 'export_evidence'; automation_id = '109'; name = 'Експортувати канонічні докази'; required_pattern = 'Invoke'; require_external_focus = $true; expected_control_type = 'ControlType.Button'; require_named_rows = $false },
