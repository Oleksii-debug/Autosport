"""Bounded Betfair Baseball terminal-outcome authority adapter.

This module extends the existing canonical ``market_outcomes`` authority issuance
boundary for Betfair Baseball without creating a second outcome engine,
...
for an OPEN Baseball MATCH_ODDS market whose runner roster is present in
...
_BETFAIR_BASEBALL_EVENT_TYPE_ID = "7511"


def assess_betfair_baseball_historical_market_definition_authority(
    *,
    market_id: str,
    ...
    """Verify one Betfair Baseball MATCH_ODDS roster."""
    ...
    if event_type_id != _BETFAIR_BASEBALL_EVENT_TYPE_ID:
    ...
    settlement_protocol = {
        "provider": _BETFAIR_SOURCE_ID,
        "sport": "baseball",
        "event_type_id": _BETFAIR_BASEBALL_EVENT_TYPE_ID,
    ...
    verification_protocol_sha256 = _sha256_payload(
        {
            "protocol": (
                "autosport.betfair_historical.baseball."
