...
def evaluate_walk_forward_bundle(bundle: WalkForwardBundle) -> dict[str, Any]:
    ...
    report: dict[str, Any] = {
        ...
        "truth": {
            ...
            # Timestamp-valid JSON does not prove that forecasts were durably
            # produced before outcome reveal. Keep this false until forecast
            # origin is bound to verifiable pre-outcome runtime/ledger evidence.
