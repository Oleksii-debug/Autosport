        ...
        comparisons.append(
            BaselineComparison(
                ...
                candidate_minus_baseline=_decimal_text(
                    _decimal_difference(candidate_value, baseline_value)
                ),
                difference_lower_bound=_decimal_text(
                    _decimal_difference(candidate_low, baseline_high)
                ),
                difference_upper_bound=_decimal_text(
                    _decimal_difference(candidate_high, baseline_low)
                ),
                ...
                total_cost_delta=_decimal_text(
                    _decimal_difference(candidate_cost, baseline_cost)
                ),
