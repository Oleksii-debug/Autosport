...
_WINDOWS_SHELL_UK_UA = MappingProxyType(
    {
        ...
        "ui.windows.manual_calculation.status.success": "Готово: канонічний результат і докази доступні лише для читання; real_money_execution=false.",
        ...
        "ui.windows.manual_calculation.result.canonical_json": "Канонічний JSON доказів (незмінений)",
        "ui.windows.manual_calculation.error.unlocalized_evidence": "Канонічний текст доказів не має українського представлення: {value}",
        ...
        "ui.windows.manual_calculation.hint.fractional_kelly": "Введіть: ймовірність, коефіцієнт, частка, ліміт — по одному значенню в рядку.",
        ...
        "ui.windows.manual_calculation.uia.calculate.description": "Запускає лише канонічний сервіс ручних розрахунків; реальні ставки не створюються.",
        "ui.windows.manual_calculation.uia.result.name": "Результат і докази ручного розрахунку",
        "ui.windows.manual_calculation.uia.result.description": "Лише для читання: канонічний результат, припущення, попередження та хеш доказів.",
