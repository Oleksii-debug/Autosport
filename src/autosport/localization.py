...
_UK_UA = MappingProxyType(
    {
        ...
        "ui.status.recovery.replay_busy": (
            "Відновлення заблоковано: економічний повтор ще виконується."
        ),
        "ui.status.recovery.live_busy": (
            "Відновлення заблоковано: поточний знімок ще виконується."
        ),
        ...
        "ui.error.recovery.configuration": (
            "Конфігурацію відновлення відхилено: {detail}"
        ),
        ...
        "ui.error.recovery.worker": (
            "Відновлення робочої області відхилено закрито при помилці: {detail}"
        ),
        ...
        "ui.status.recovery.ready_suffix": (
            ". Робоча область готова до наступного перевіреного паперового повтору."
        ),
        "ui.info.recovery.complete": (
            "Відновлення робочої області завершено без невирішених запусків."
        ),
