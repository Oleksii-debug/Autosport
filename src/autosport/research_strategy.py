...
def _validate_scenario_future_identity(
    ...
    """Reject replay identities and market namespaces unknowable at decision time."""
    ...
    for group in groups:
        for outcome in group.outcomes:
            ...
            if len(parts) != 3:
                continue
            first_observed_market = first_observed_market_times.get((parts[0], parts[1]))
            if first_observed_market is not None and first_observed_market > decision_time:
                raise ValueError(
