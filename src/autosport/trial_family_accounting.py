...
class TrialFamilyDefinition:
    ...
    def identity_payload(self) -> dict[str, Any]:
        return {
            ...
            "multiplicity_contract_sha256": self.multiplicity_contract_sha256.lower(),
    ...
    def resolve(cls, registry: ScientificRegistry, plan: ExperimentFamilyPlan) -> "TrialFamilyDefinition":
        ...
        identity = {
            ...
            "multiplicity_contract_sha256": plan.plan_sha256,
            "stopping_rule_sha256": _text_sha256(stopping_rule, "stopping_rule"),
            "multiple_comparison_control_sha256": _text_sha256(multiple_comparison_control, "multiple_comparison_control"),
...
class TrialFamilyAccountingStore:
    ...
    def _authority(self, family_id: str) -> MonotonicWorkspaceAuthority:
        return MonotonicWorkspaceAuthority(
            ...
            key=_sha256(family_id, "family_id"),
    ...
    def initialize_pristine(cls, path: str | Path, registry: ScientificRegistry, plan: ExperimentFamilyPlan, *, workspace_root: str | Path | None = None, authority_root: str | Path | None = None) -> "TrialFamilyAccountingStore":
        ...
        state = {"schema_version": cls.SCHEMA_VERSION, "family": family.to_payload(), "multiplicity_plan": plan.to_payload(), "sequential_store": relative_sequential, "events": []}
        intended = _state_sha256(state)
        binding = _digest({"family_id": family.family_id, "kind": "INITIALIZE", "sequential_store": relative_sequential})
    ...
    def _load_json(self) -> dict[str, Any]:
        ...
        if type(state) is not dict or set(state) != {"schema_version", "family", "multiplicity_plan", "sequential_store", "events"}:
