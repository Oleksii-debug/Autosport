...
def test_unrelated_ledger_append_does_not_rewrite_realized_match_identity(
    ...
    # The mutable whole-ledger tail is expected to change. It must not become part
    # of the historical provider-evidence identity for this unchanged attempt and
    # byte-identical authoritative readback.
