...
def test_backdated_declared_start_cannot_fake_multiday_observed_span() -> None:
    identity = CampaignQualificationIdentity(
        campaign_id="campaign-observed-span",
    ...
    episode = EpisodeQualificationEvidence(
        ...
        observation=_anchor("observation", "1", "2026-09-22T00:00:00Z"),
        denominator_member=_anchor(
            "denominator",
            "2",
            "2026-09-22T00:00:00Z",
        ),
        decision=_anchor("decision", "3", "2026-09-22T00:01:00Z"),
        decision_kind=DecisionKind.WAIT,
        paper_action=None,
        execution_disposition=ExecutionDisposition.NOT_APPLICABLE,
        terminal_resolution=_anchor(
            "evaluation",
            "4",
            "2026-09-22T00:02:00Z",
        ),
        cost_evidence=_anchor("cost", "5", "2026-09-22T00:03:00Z"),
        economic_completeness="COMPLETE_NET_ECONOMICS",
        utility_evidence=_anchor("utility", "6", "2026-09-22T00:04:00Z"),
        learning_evidence=_anchor("learning", "7", "2026-09-22T00:05:00Z"),
        checkpoint=_anchor("checkpoint", "8", "2026-09-22T00:06:00Z"),
    )
    episodes = (episode,)
    stop = _anchor("stop", "9", "2026-09-22T00:07:00Z")
    terminal_bundle = EvidenceAnchor(
        authority_family="canonical.test",
        evidence_id="terminal-bundle",
        sha256=structural_terminal_bundle_sha256(identity, episodes, stop),
        available_at="2026-09-22T00:08:00Z",
    )
