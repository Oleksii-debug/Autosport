...
class ProviderProbabilityAgentTests(unittest.TestCase):
    ...
    def test_paper_value_agent_without_execution_authority_does_not_open_ticket(self):
        ...
        self.assertTrue(
            any("canonical #623 execution runtime/account authority is unavailable" in note for note in context.notes)
        )
