...
class StrategyComparisonOpenExposureTests(unittest.TestCase):
    def test_loader_does_not_assume_committed_stake_is_zero(self):
        """Canonical paper profit includes open committed stake, which is not serialized here."""
        with tempfile.TemporaryDirectory() as temp:
            ...
            payload = {
                ...
                # A canonical PaperBook may have 100 of open committed stake:
                # balance=9900, committed_stake=100, initial=10000 => net_profit=0.
                # committed_stake is not part of the durable run-summary contract,
                # so the comparison loader must not assume it is zero.
                "balance": "9900",
                "evaluation": {
