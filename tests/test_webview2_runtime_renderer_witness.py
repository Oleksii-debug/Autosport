...
class _FakeWebview:
    def __init__(self, selected_renderer: str) -> None:
...
def _install_fake_webview(monkeypatch, selected_renderer: str) -> _FakeWebview:
    fake = _FakeWebview(selected_renderer)
