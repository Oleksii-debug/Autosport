...
def test_dynamic_disclosures_expose_state_to_screen_readers() -> None:
    ...
    # Opening and closing must update the control's exposed state as well as visual
    # visibility; hidden alone does not tell an NVDA user whether the button is
    # currently expanded.
    ...
    # Preserve the existing deterministic focus transitions.
